...
df_books = pd.read_csv(r'/Users/ketanchavan/Downloads/Book-Recommender-master/data/BX-Books.csv', sep=';', encoding='latin-1')
df_books_ratings = pd.read_csv(r'/Users/ketanchavan/Downloads/Book-Recommender-master/data/BX-Book-Ratings-Subset.csv', sep=';', encoding='latin-1')
df_users = pd.read_csv(r'/Users/ketanchavan/Downloads/Book-Recommender-master/data/BX-Users.csv', sep=';', encoding='latin-1')
